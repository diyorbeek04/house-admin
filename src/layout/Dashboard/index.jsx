  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
        <ListItem key={"Residences"} disablePadding sx={{ display: 'block' }}>
              ...
              >
                ...
                <ListItemText primary={"Residences"} sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
        </List>
        <List>
        <ListItem key={"Deals"} disablePadding sx={{ display: 'block' }}>
              ...
              >
                ...
                <ListItemText primary={"Deals"} sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
        </List>
        <List>
